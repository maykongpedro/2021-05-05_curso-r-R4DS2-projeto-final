...
ssp_pivot_categorico %>% 
    ...
    #     compact = TRUE,
    #     columns = list(
    #         crime_cometido = reactable::colDef("Crime/Ocorrência"),
    #         categoria = reactable::colDef("Categoria teórica")
    #     )
    # )
  ...
  # adiciona headers
  gt::tab_header(
    title = "Crimes e categorias por ocorrência",
    subtitle = "Classificação realizada para a análise"
  ) %>% 
  # rotulos das colunas
  gt::cols_label(
    crime_cometido = "Crime/Ocorrência",
    categoria = "Categoria teórica"
  ) %>% 
  # rodapé
  gt::tab_source_note(
