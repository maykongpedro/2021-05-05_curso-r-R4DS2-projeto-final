...
```{r echo=FALSE}
# Ler base
ssp_2019_shp_tx_geral <- readr::read_rds("./data/ssp_2019_shp_tx_geral.rds")
base_muni <- readr::read_rds("./data/base_muni_sp.rds")

# Carregar função
source("R/3-ggplot-sf-mapa-municipios.R")
...
```{r echo=FALSE}
# Ler base
ssp_2019_shp_tx_categoria <- readr::read_rds("./data/ssp_2019_shp_tx_categoria.rds")

# Carregar função
source("R/4-ggplot-sf-mapa-municipios-facet.R")
