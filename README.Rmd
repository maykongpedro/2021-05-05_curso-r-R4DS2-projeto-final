...
Na mapaa² baixo podemos verificar a distribuição espacial das taxas de ocorrência por 100mil hab. de todas as cidades com o mínimo de habitantes necessário para a correta utilização desse cálculo, sendo a cor um indicadito da intensidade da classe de ocorrências³.
...
# Conclusões
Apesar de não ser uma análise extremamente complexa,foi possível retirar algumas respostas a partir dos dados, como: 
