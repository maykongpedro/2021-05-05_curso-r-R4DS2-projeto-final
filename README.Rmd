...
## Motivação
Esse repositório tem como movitação servir de entrega para o trabalho final de conclusão de curso do Curso: R para Ciência de Dados 2 da Curso R.

## Objetivo
Analisar umas das bases disponibilizadas pelos professores utilizando o conhecimento adquirido no curso.
...
- Descrição: _simple feature_ dos municípios do estado de São Paulo.
- Variáveis: codigo_ibge, municipio_nome, colunas respectivas para cada ano (2002 a 2020)
